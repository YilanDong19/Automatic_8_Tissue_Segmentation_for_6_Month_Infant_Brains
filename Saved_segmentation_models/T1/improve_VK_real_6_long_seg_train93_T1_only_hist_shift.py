...
root_dir = '/nfs/home/ydong/code/VK_improve_seg/T1_93_hist_shift/save_model'
train_path_6_month = '/nfs/home/ydong/dataset/improve_segmentation_dataset_2/train/'
val_path_6_month = '/nfs/home/ydong/dataset/improve_segmentation_dataset_2/val/'
test_path_6_month = '/nfs/home/ydong/dataset/improve_segmentation_dataset/test/'
apply_path_6_month = '/nfs/home/ydong/dataset/apply/seg_8_tissues/'
...
train_labels = sorted(glob.glob(os.path.join(train_path_6_month, '*_prediction.nii.gz')))

train_dicts_6_month = [
    {"image_T1": image_T1, "image_label": image_label, "affine": nib.load(image_T1).affine, "image_name": os.path.basename(image_T1)[0:12]}
    for image_T1, image_label in zip(train_images_T1, train_labels)
]

train_transform_6_month = Compose(
    [
        LoadImaged(reader=NibabelReader, keys=["image_T1", "image_label"]),
        EnsureChannelFirstd(keys=["image_T1"]),
        ConvertToMultiChannel_com(keys="image_label"),
        RandAffined(keys=["image_T1","image_label"], 
        ...
        ScaleIntensityd(keys=["image_T1"],minv=0,maxv=1),
        RandHistogramShiftd(keys=["image_T1"],
                            prob=0.5,
...
val_images_labels = sorted(glob.glob(os.path.join(val_path_6_month, '*_VK.nii.gz')))

val_dicts_6_month = [
    {"image_T1": image_T1, "image_label": image_label, "affine": nib.load(image_T1).affine, "image_name": os.path.basename(image_T1)[0:12]}
    for image_T1, image_label in zip(val_images_T1, val_images_labels)
]
...
test_dicts_6_month = [
    {"image_T1": image_T1, "affine": nib.load(image_T1).affine, "image_name": os.path.basename(image_T1)[0:12]}
    for image_T1 in test_images_T1
]

test_transform_6_month = Compose(
    [
        LoadImaged(reader=NibabelReader, keys=["image_T1"]),
        EnsureChannelFirstd(keys=["image_T1"]),
        # ConvertToMultiChannel_com(keys="image_label"),
        ScaleIntensityd(keys=["image_T1"],minv=0,maxv=1),
        # HistogramNormalized(keys=["image_T2"],min=-1,max=1),
...
apply_dicts_6_month = [
    {"image_T1": image_T1, "affine": nib.load(image_T1).affine, "image_name": os.path.basename(image_T1)[0:12]}
    for image_T1 in apply_images_T1
]
...
class InfantSeg(object):
        ...
        for epoch in range(self.start_epoch, args.epochs+1):
            ...
            if epoch ==1:
                for idx, month_6_real in enumerate(self.val_loader_6_month):
                    ...
                    nib.save(img_save, root_dir +'/val_result/' + month_6_name + '_old_prediction' + '.nii.gz')
            ...
            for idx, month_6_real in enumerate(self.train_loader_6_month):
                ...
                month_6_real_T1, month_6_label = cuda([month_6_real_T1, month_6_label])                              
                data_combine = month_6_real_T1
                ...
                if idx==2 :
                    ...
                    ax2[0,1].title.set_text('old_prediction')
                    ax2[0,1].imshow(np.rot90(month_6_label_plot[0 ,0, :, :, round(month_6_label_plot.shape[4]/2)],k=3), cmap="jet",vmin=0,vmax=9)
                    ax2[0,2].title.set_text('new_outputs')
                    ...
                    ax2[1,1].title.set_text('old_prediction')
                    ax2[1,1].imshow(np.rot90(month_6_label_plot[0, 0, :, round(month_6_label_plot.shape[3]/2),:],k=1), cmap="jet",vmin=0,vmax=9)  
                    ax2[1,2].title.set_text('new_outputs')
                    ...
                    ax2[2,1].title.set_text('old_prediction')
                    ax2[2,1].imshow(np.rot90(month_6_label_plot[0, 0, round(month_6_label_plot.shape[2]/2), :,:],k=1), cmap="jet",vmin=0,vmax=9) 
                    ax2[2,2].title.set_text('new_outputs')
            ...
            if epoch % 10 ==0:
                ...
                for idx, month_6_real in enumerate(self.val_loader_6_month):
                    ...
                    ax[0,1].title.set_text('VK_labels')
                    ...
                    ax[1,1].title.set_text('VK_labels')
                    ax[1,1].imshow(np.rot90(month_6_label_plot[0, 0, :, round(month_6_label_plot.shape[3]/2),:],k=1), cmap="jet",vmin=0,vmax=9)  
                    ...
                    ax[2,1].title.set_text('VK_labels')
                    ax[2,1].imshow(np.rot90(month_6_label_plot[0, 0, round(month_6_label_plot.shape[2]/2), :,:],k=1), cmap="jet",vmin=0,vmax=9) 
                ...
                if average_test_dice>=self.best_val_accuracy:
                    ...
                    record_metric(csv_record_data, root_dir+'/val_result/'+'6_Cyc+Att+iBeat+Att.csv')
                    with open(root_dir+'/val_result/'+'results.txt',"a") as file:
    ...
    def test(self,args):
        ...
        for idx, month_6_real in enumerate(self.test_loader_6_month):
            ...
            month_6_real_T1 = cuda([month_6_real_T1])[0]                              
            data_combine = month_6_real_T1
            ...
            ax5[0,1].title.set_text('Seg_outputs')
            ax5[0,1].imshow(np.rot90(Seg_out_argmax[0 , :, :, round(Seg_out_argmax.shape[3]/2)],k=3), cmap="jet",vmin=0,vmax=9)   
            ...
            ax5[1,1].title.set_text('Seg_outputs')
            ax5[1,1].imshow(np.rot90(Seg_out_argmax[0, :, round(Seg_out_argmax.shape[2]/2),:]), cmap="jet",vmin=0,vmax=9)  
            ...
            ax5[2,1].title.set_text('Seg_outputs')
            ax5[2,1].imshow(np.rot90(Seg_out_argmax[0, round(Seg_out_argmax.shape[2]/2), :,:]), cmap="jet",vmin=0,vmax=9)  
    ...
    def segment_all(self,args):
        ...
        for idx, month_6_real in enumerate(self.train_loader_6_month_withoutaff):
            ...
            img_save = nib.Nifti1Image(np.float64(Seg_out_argmax[0,:,:,:]), month_6_affine.detach().cpu().numpy()[0,:,:])
            nib.save(img_save, all_seg_path +'/' + month_6_name + '_new_prediction' + '.nii.gz')
            ...
            nib.save(img_save, all_seg_path +'/' + month_6_name + '_old_prediction' + '.nii.gz')  
            ...
            ax6[0,1].title.set_text('old_prediction')
            ax6[0,1].imshow(np.rot90(month_6_label_plot[0 ,0, :, :, round(month_6_label_plot.shape[4]/2)],k=3), cmap="jet",vmin=0,vmax=9)
            ax6[0,2].title.set_text('new_outputs')
            ...
            ax6[1,1].title.set_text('old_prediction')
            ax6[1,1].imshow(np.rot90(month_6_label_plot[0, 0, :, round(month_6_label_plot.shape[3]/2),:],k=1), cmap="jet",vmin=0,vmax=9)  
            ax6[1,2].title.set_text('new_outputs')
            ...
            ax6[2,1].title.set_text('old_prediction')
            ax6[2,1].imshow(np.rot90(month_6_label_plot[0, 0, round(month_6_label_plot.shape[2]/2), :,:],k=1), cmap="jet",vmin=0,vmax=9) 
            ax6[2,2].title.set_text('new_outputs')
        ...
        average_6month = 0
        csv_record_data = []        
        for idx2, month_6_real in enumerate(self.val_loader_6_month):
            ...
            ax7[0,0].title.set_text('6month_real_T1')
            ax7[0,0].imshow(np.rot90(month_6_real_T1[0, 0, :, :,round(month_6_real_T1.shape[4]/2)],k=3),cmap="gray")
            ...
            ax7[0,2].title.set_text('Seg_outputs')
            ax7[0,2].imshow(np.rot90(Seg_out_argmax[0 , :, :, round(Seg_out_argmax.shape[3]/2)],k=3), cmap="jet",vmin=0,vmax=9)   
                    
                    
            ax7[1,0].title.set_text('6month_real_T1')
            ax7[1,0].imshow(np.rot90(month_6_real_T1[0, 0, :, round(month_6_real_T1.shape[3]/2),:],k=1),cmap="gray")
            ...
            ax7[1,2].title.set_text('Seg_outputs')
            ax7[1,2].imshow(np.rot90(Seg_out_argmax[0, :, round(Seg_out_argmax.shape[2]/2),:]), cmap="jet",vmin=0,vmax=9)  
                     

            ax7[2,0].title.set_text('6month_real_T1')
            ax7[2,0].imshow(np.rot90(month_6_real_T1[0, 0, round(month_6_real_T1.shape[2]/2), :,:],k=1),cmap="gray")
            ...
            ax7[2,2].title.set_text('Seg_outputs')
            ax7[2,2].imshow(np.rot90(Seg_out_argmax[0, round(Seg_out_argmax.shape[2]/2), :,:]), cmap="jet",vmin=0,vmax=9)  
        ...
        average_6month = average_6month / (idx2+1)
...
class Seg_apply(object):
    ...
    def apply(self,args):
        ...
        for idx, month_6_real in enumerate(self.apply_loader_6_month):
            ...
            ax8[0,0].title.set_text('6month_real_T1')
            ax8[0,0].imshow(np.rot90(month_6_real_T1[0, 0, :, :,round(month_6_real_T1.shape[4]/2)],k=3),cmap="gray")
            ax8[0,1].title.set_text('Seg_outputs')
            ax8[0,1].imshow(np.rot90(Seg_out_argmax[0 , :, :, round(Seg_out_argmax.shape[3]/2)],k=3), cmap="jet",vmin=0,vmax=9)   
                    
                    

            ax8[1,0].title.set_text('6month_real_T1')
            ax8[1,0].imshow(np.rot90(month_6_real_T1[0, 0, :, round(month_6_real_T1.shape[3]/2),:],k=1),cmap="gray")
            ax8[1,1].title.set_text('Seg_outputs')
            ax8[1,1].imshow(np.rot90(Seg_out_argmax[0, :, round(Seg_out_argmax.shape[2]/2),:]), cmap="jet",vmin=0,vmax=9)  
                     
                    
                    
            ax8[2,0].title.set_text('6month_real_T1')
            ax8[2,0].imshow(np.rot90(month_6_real_T1[0, 0, round(month_6_real_T1.shape[2]/2), :,:],k=1),cmap="gray")
            ax8[2,1].title.set_text('Seg_outputs')
            ax8[2,1].imshow(np.rot90(Seg_out_argmax[0, round(Seg_out_argmax.shape[2]/2), :,:]), cmap="jet",vmin=0,vmax=9)  

            suptitle_name = month_6_name
            fig8.suptitle(suptitle_name)
            fig8.savefig(apply_subjects_path+'/'+ month_6_name +'.png')    
...
def get_args():
    ...
    parser.add_argument('--applying', type=bool, default=True)
